...
&emsp;&emsp;[1. 面向过程程序设计](#1-面向过程程序设计)
&emsp;&emsp;[2. 面向对象程序设计](#2-面向对象程序设计)
[二、创建对象的方法](#二、创建对象的方法)
&emsp;&emsp;[1. 创建字面量和实例](#1-创建字面量和实例)
&emsp;&emsp;[2. 工厂模式](#2-工厂模式)
&emsp;&emsp;[3. 构造函数](#3-构造函数)
&emsp;&emsp;[4. 原型模式](#4-原型模式)
&emsp;&emsp;[5. 混合模式(推荐使用)](#5-混合模式-推荐使用)
[三、原型，原型链](#三、原型，原型链)
&emsp;&emsp;[1. 原型对象](#1-原型对象)
&emsp;&emsp;[2. __proto__和prototype的区别](#2-proto-和prototype的区别)
&emsp;&emsp;[3. 继承](#3-继承)
&emsp;&emsp;[4. ES6新方法－－class](#4-ES6新方法－－class)
