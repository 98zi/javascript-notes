...
[一、什么是DOM？](#一、什么是DOM？)
[二、节点树](#二、节点树)
&emsp;&emsp;[1. 节点类型](#1-节点类型)
&emsp;&emsp;[2. 属性](#2-属性)
&emsp;&emsp;[3. 文档节点－－document](#3-文档节点－－document)
&emsp;&emsp;&emsp;&emsp;[(1) 获取](#1-获取)
&emsp;&emsp;&emsp;&emsp;[(2) 创建](#2-创建)
&emsp;&emsp;&emsp;&emsp;[操作css](#操作css)
&emsp;&emsp;[4. 元素节点(element对象)](#4-元素节点-element对象)
&emsp;&emsp;&emsp;&emsp;[(1) 节点属性](#1-节点属性)
&emsp;&emsp;&emsp;&emsp;[(2) 节点方法](#2-节点方法)
&emsp;&emsp;[5. 属性节点(Attr对象)](#5-属性节点-Attr对象)
---
